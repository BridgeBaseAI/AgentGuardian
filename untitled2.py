...
!pip install -q fastapi uvicorn nest_asyncio web3 google-genai requests
...
thread.start()
print("🚀 AgentGuardian is starting on http://127.0.0.1:8000")
...
!pip uninstall -y requests fastapi

# 2. Install the Colab-compatible versions + your project tools
!pip install -q "requests==2.32.4" "fastapi>=0.115.0,<0.124.0" google-genai web3 uvicorn